...
const ProjectsTable = (props: { projects: IProjectEntity[], month: number }) => {
  ...
  const calculateTotal = (commissionValue: number, dealDate: string, numberOfInstallments: number) => {
    const monthsWithBonus = ReportServices.defineMonthsWithBonus(commissionValue, dealDate, numberOfInstallments);
                ...
                <>
                  <StyledTableRow key={project.id}>
                    ...
                    <StyledTableCell>
                      ...
                      {calculateTotal(project.commissionValue, project.dealDate, project.numberOfInstallments)}
                      </>
                    </StyledTableCell>
                    <StyledTableCell>
                    ...
                    <StyledTableCell>
                      <IconButton
                        ...
                        size="small"
                        onClick={() => setOpen((oldOpen) => ({...oldOpen, [project.id] : !oldOpen[project.id]}))}
                      >
                        {open[project.id] ? (
                          <KeyboardArrowUpIcon />
                        ) : (
